...
//	@Query("select u from usuarios u where u.username=?1") // Ejemplo si tuviéramos dos parámetros (en los parámetros del método tendríamos otro, ej.: (String username, String otro)): "select u from usuarios u where u.username=?1 and u.otro=?2"
